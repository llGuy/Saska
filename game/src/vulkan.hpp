...
struct model_t
{
    ...
    {
        raw_cache_for_rendering.allocate(binding_count);
...
graphics_api_initialize_ret_t initialize_graphics_api(create_vulkan_surface *create_proc, display_window_information_t window_info);
...
frame_rendering_data_t begin_frame_rendering(display_window_information_t window_info);
void end_frame_rendering_and_refresh(display_window_information_t window_info);
